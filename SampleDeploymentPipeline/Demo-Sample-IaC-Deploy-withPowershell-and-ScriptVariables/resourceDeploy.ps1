...
-Name "Deploy_RG" `
-TemplateFile .\SampleDeploymentPipeline\BOS-Sample-IaC-Deploy-withPowershell-and-ScriptVariables\resourcegroupDeploy.bicep `
-envCode $envCode `
-location $location `
-ownerteam $ownerteam `
...
-TemplateFile .\SampleDeploymentPipeline\BOS-Sample-IaC-Deploy-withPowershell-and-ScriptVariables\OtherResourcesDeploy-withscope.bicep `
